...
const History = () => {
  ...
  return (
      ...
      <div className='mt-5'>
        {discussionRoomList && discussionRoomList?.map((item, index) => (item.coachingOption == "Topic Base Lecture" || item.coachingOption == "Learn Language" || item.coachingOption == "Meditation") && (
