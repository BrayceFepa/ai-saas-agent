export const ExpertsList = [
    {
        ...
        abstract: '/ab1.png',
        placeholder:"eg: Artificial Intelligence, history of ancient Egypt, programming, etc.."
    },
    {
        name: 'Mock Interview',
        icon: '/interview.png',
        ...
        abstract: '/ab2.png',
        placeholder:"eg: React Js , Python, Data Science, etc.."
    ...
    },
    {
        ...
        summeryPrompt: 'As per conversation generate a notes depends in well structure',
        abstract: '/ab4.png',
        placeholder:"eg: French, English, Spanish, etc.."
    ...
    },
    {
        ...
        summeryPrompt: 'As per conversation generate a notes depends in well structure',
        abstract: '/ab5.png',
        placeholder:"eg: how to clear your mind, how to stay zen"
